...
public struct KaanjuCountry: Identifiable, Sendable, Equatable {
...
public enum KaanjuCountries {
    /// All ISO regions with names, localized and sorted. Computed once.
    public static let all: [KaanjuCountry] = {
    ...
    public static var current: KaanjuCountry? {
        let code: String?
        if #available(iOS 16, macOS 13, *) {
